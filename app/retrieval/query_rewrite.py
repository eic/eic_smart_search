...
REWRITE_SYSTEM_PROMPT = (
    ...
    "ALWAYS expand known acronyms to their full form on at least one variant, "
    "e.g. TDR -> Technical Design Report, EIC -> Electron Ion Collider, "
    "DIS -> Deep Inelastic Scattering, SRO -> Streaming Readout, "
    "DIRC -> Detection of Internally Reflected Cherenkov light, "
    "EEEMCal / BEMC / FEMC calorimeter names kept as-is but also expanded to "
    "Backward/Forward/Barrel Electromagnetic Calorimeter when useful. "
